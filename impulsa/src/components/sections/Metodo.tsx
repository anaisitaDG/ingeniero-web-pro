...
export function Metodo() {
  return (
    <section className="section" style={{ borderTop: "1px solid #111" }}>
      ...
      <div className="flex flex-col" style={{ borderTop: "1px solid #111" }}>
        {pasos.map((paso, i) => (
          <Reveal key={paso.num} delay={i * 0.08}>
            ...
            >
              <span
                className="font-black tracking-tighter shrink-0 w-16 group-hover:text-white transition-colors duration-300"
                style={{
              ...
              <div className="flex flex-col sm:flex-row sm:items-baseline gap-2 sm:gap-8 pt-1">
                <h3
                  ...
                  style={{ fontSize: "clamp(16px, 1.6vw, 22px)", color: "#fff" }}
                >
                  {paso.titulo}
                </h3>
                <p
                  className="font-light"
                  style={{ fontSize: "clamp(14px, 1.2vw, 17px)", color: "#444" }}
                >
                  {paso.texto}
                </p>
              </div>
